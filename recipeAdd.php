...
<div class="container">
            <form class="insert-form" id="insert_form" method="POST" action="">
                ...
                <div class="container">
                    ...
                    <div class="">
                        <input type="number" class="form-control" id="calorie" name="calorie" placeholder="Enter the calorie count">
                    </div>
                </div>
                ...
                <?php 
                    ...
                    if (isset($_POST['saveBtn'])) {
                        ...
                        $csquery = mysqli_query($cconn, "SELECT MAX(recipe) AS rID FROM recipe");
                        $rrroww = mysqli_fetch_array($csquery);
                        $rrrowi1 = $rrroww["rID"];
                        $rrrowi1++;
                        $cdate = date("Y/m/d");

                        $ssave = "INSERT INTO recipe(recipe, recipename, calorie, created) VALUES ('".$rrrowi1."','".$recipen."', '".$calorie."', '".$cdate."')";         
                        ...
                        <?php 
                            ...
                            if (isset($_POST['saveBtn'])) {
                                ...
                                foreach ($ingredient as $key => $value) {
                                    ...
                                    $save ="INSERT INTO meal(rID, ingredient, measurement) VALUES('".$rrrowi."','".$value."', '".$measurement[$key]."')";
                        ...
                        <?php 
                            ...
                            if (isset($_POST['saveBtn'])) {
                                ...
                                foreach ($stepNo as $kkey => $vvalue) {
                                    ...
                                    $save = "INSERT INTO recinst(recID, stepNo, direction) VALUES ('".$rrowii."','".$vvalue."', '".$direction[$kkey]."')";
